...
module.exports = async(oldChannel, newChannel) => {
    ...
    if (oldChannel.name !== newChannel.name) {
        ...
        .setTitle('Channel Updates')
        .addFields({ name: 'Channel NSFW Changed', value: `${oldChannel.nsfw} -> ${newChannel.nsfw}` })
        .setColor("Green")
        .setTimestamp()
        ...
        .setTitle('Channel Updates')
        .addFields({ name: 'Channel Bitrate Changed', value: `${oldChannel.bitrate} -> ${newChannel.bitrate}` })
        .setColor("Green")
        .setTimestamp()
